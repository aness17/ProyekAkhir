      ...
      <div class="row gy-4">
        <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="400">
          <div class="service-item position-relative">
            ...
            <h4 style="text-align: center ;font-family:serif ;font-size: medium;"><a href="" class="stretched-link">Viera Oleh-oleh Raih Juara 2 Pada Anugerah Pesona Indonesia</a></h4>
          </div>
        ...
        <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-out">
          <div class="service-item position-relative">
            ...
            <br />
            <h4 style="text-align: center ; font-family:serif ; font-size: medium;"><a href="" class="stretched-link">Viera Oleh-oleh Bekerjasama dengan Dinas Pariwisata dan Kebudayaan Kota Pekanbaru</a></h4>
          </div>
        </div><!-- End Service Item -->
        <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-out">
          <div class="service-item position-relative">
            ...
            <br />
            <h4 style="text-align: center ;font-family:serif ;font-size: medium;"><a href="" class="stretched-link">Viera Oleh-oleh Raih Rekor Muri Ketan Talam Durian Terpanjang</a></h4>
          </div>
        </div><!-- End Service Item -->
