            ...
            <div class="table-responsive">
                <table class="table table-bordered dataTable" cellspacing="0">
                    ...
                    <script>
                        ...
                        cetak.addEventListener("click", (e) => {
                            console.log(`<?= base_url() ?>index.php/superadmin/cetak/${sessionStorage.getItem('filter')}/${sessionStorage.getItem('date')}`)
                            location.href = `<?= base_url() ?>index.php/superadmin/cetak/${sessionStorage.getItem('filter')}/${sessionStorage.getItem('date')}`
                        })
                        cetakexcel.addEventListener("click", (e) => {
                            console.log(`<?= base_url() ?>index.php/superadmin/cetakexcel/${sessionStorage.getItem('filter')}/${sessionStorage.getItem('date')}`)
                            location.href = `<?= base_url() ?>index.php/superadmin/cetakexcel/${sessionStorage.getItem('filter')}/${sessionStorage.getItem('date')}`
                        })
                        tombol.addEventListener("click", (e) => {
                            const a = filter.value
                            let date = ''
